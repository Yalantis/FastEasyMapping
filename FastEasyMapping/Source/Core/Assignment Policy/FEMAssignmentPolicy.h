...
/**
 ...
 @discussion Given values: A (old), B (new). Result of assingment is B, A remains untouched (not removed from the database).
 */
...
/**
 ...
 @discussion Given values: A (old), B (new). Result of assingment is either B or A in case B is nil.
...
/**
 ...
 @discussion Given two collections: [A, B, C, D] and [1, 2, 3, 4]. Result of assingment is a merged collection: [A, B, C, D, 1, 2, 3, 4].
...
/**
 ...
 @discussion Given values: A (old), B (new). Result of assingment is B. A removed from the database.
...
/**
 ...
 @discussion Given two collections: [A, B, C, D] and [1, 2, 3, 4]. Result of assingment is a collection: [1, 2, 3, 4].
