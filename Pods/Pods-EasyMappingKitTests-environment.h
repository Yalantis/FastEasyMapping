...
// CMFactory
#define COCOAPODS_POD_AVAILABLE_CMFactory
#define COCOAPODS_VERSION_MAJOR_CMFactory 1
#define COCOAPODS_VERSION_MINOR_CMFactory 3
#define COCOAPODS_VERSION_PATCH_CMFactory 1
